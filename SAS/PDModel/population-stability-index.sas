...
/* hist_table_final: contains the stacked dataset being reviewed on a monthly basis */
...
/*	else if est_total_score <=&band2 then group_band = 2;*/
/*	else if est_total_score <=&band3 then group_band = 3;*/
/*	else if est_total_score <=&band4 then group_band = 4;*/
/*	else if est_total_score <=&band5 then group_band = 5;*/
/*	else if est_total_score <=&band6 then group_band = 6;*/
/*	else if est_total_score <=&band7 then group_band = 7;*/
/*	else if est_total_score <=&band8 then group_band = 8;*/
/*	else if est_total_score <=&band9 then group_band = 9;*/
/*	else if est_total_score <=&band10 then group_band = 10;*/
/*	else group_band = 10;*/
...
/* CODE used for testing the PSI logic */

/*%let base_mth = 01mar2008;*/
/*%let comp_mth = 01mar2008;*/

/* Test comparing base (currently Mar08) and first month */
/*proc sql;*/
/*	create table review as*/
/*	select "&base_mth."d format date9. as base, "&comp_mth."d format date9. as comp,*/
/*		t1.group_band, */
/*		t1.band_freq as base_freq,*/
/*		t2.band_freq as comp_freq*/
/*	from bands (where=(month = "&base_mth."d)) t1*/
/*	left join bands (where=(month = "&comp_mth."d)) t2*/
/*		on t1.group_band = t2.group_band*/
/*	;*/
/*run;*/
