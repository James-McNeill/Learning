# Import the operator - this acts as a wrapper around the spark-submit method
...
# Example - shows a daily data cleaning pipeline
...
# Example - schedule the three tasks to run together in the correct order
