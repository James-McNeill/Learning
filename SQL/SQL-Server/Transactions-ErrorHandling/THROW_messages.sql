...
-- Add the error message to the system procedure sp_addmessage. This enables a new error message to be added. The error number must be >= 50000, as
-- these numbers represent the user defined error number range.
