-- 1. Create stored procedure that will compute the borough stats
...
-- 2. Create SP that will compute variables for each pickup location and shift in NYC Borough
